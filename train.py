...
parser.add_argument('--embedding-size', type=int, default=200, help='size of word embeddings')
parser.add_argument('--hidden-size', type=int, default=200, help='number of hidden units per layer')
...
model = model.RNNModel(args.model, num_tokens, args.embedding_size, args.hidden_size, args.num_layers, args.dropout,
                       args.tied).to(device)
